...
IFontDisp = Font
__all__ = [ 'Checked', 'LoadPictureConstants', 'OLE_XPOS_HIMETRIC',
           'FONTNAME', 'FONTSTRIKETHROUGH', 'Gray', 'FontEvents',
           'IFontEventsDisp', 'OLE_YSIZE_CONTAINER', 'Unchecked',
           'OLE_XSIZE_HIMETRIC', 'Default', 'OLE_XSIZE_CONTAINER',
           'Color', 'OLE_YPOS_CONTAINER', 'IFontDisp', 'OLE_TRISTATE',
           'IPicture', 'OLE_HANDLE', 'IFont', 'Picture',
           'OLE_OPTEXCLUSIVE', 'VgaColor', 'StdFont',
           'OLE_YPOS_HIMETRIC', 'OLE_CANCELBOOL',
           'OLE_XPOS_CONTAINER', 'StdPicture', 'OLE_XPOS_PIXELS',
           'FONTBOLD', 'FONTUNDERSCORE', 'OLE_COLOR', 'Font',
           'OLE_XSIZE_PIXELS', 'FONTSIZE', 'FONTITALIC',
           'OLE_YPOS_PIXELS', 'OLE_ENABLEDEFAULTBOOL', 'IPictureDisp',
           'OLE_YSIZE_HIMETRIC', 'OLE_YSIZE_PIXELS', 'Monochrome']
